...
class Ui_Word2VecDialog(object):
    def setupUi(self, Word2VecDialog):
        ...
        Word2VecDialog.resize(658, 706)
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(Word2VecDialog)
        ...
        self.algorithmRadioLbl.setMinimumSize(QtCore.QSize(155, 20))
        ...
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.algorithmsGroupBox)
        ...
        self.verticalLayout_3.addWidget(self.CBOWRadio)
        ...
        self.verticalLayout_3.addWidget(self.skipGramRadio)
        ...
        self.configVLayout.addWidget(self.word2VecConfigGBox)
        ...
        Word2VecDialog.setTabOrder(self.filePathField, self.wordFrequencyField)
        Word2VecDialog.setTabOrder(self.wordFrequencyField, self.vectorSizeField)
        Word2VecDialog.setTabOrder(self.vectorSizeField, self.trainingSpeedField)
        Word2VecDialog.setTabOrder(self.trainingSpeedField, self.negativeSamplingField)
        Word2VecDialog.setTabOrder(self.negativeSamplingField, self.negativeSamplingExpField)
        Word2VecDialog.setTabOrder(self.negativeSamplingExpField, self.windowField)
        Word2VecDialog.setTabOrder(self.windowField, self.CBOWRadio)
        Word2VecDialog.setTabOrder(self.CBOWRadio, self.skipGramRadio)
        Word2VecDialog.setTabOrder(self.skipGramRadio, self.epochNumberField)
        Word2VecDialog.setTabOrder(self.epochNumberField, self.nounOnlyCheck)
        Word2VecDialog.setTabOrder(self.nounOnlyCheck, self.createLogTextEdit)
        Word2VecDialog.setTabOrder(self.createLogTextEdit, self.createModelBtn)
        Word2VecDialog.setTabOrder(self.createModelBtn, self.tabWidget)
        Word2VecDialog.setTabOrder(self.tabWidget, self.selectModelField)
        Word2VecDialog.setTabOrder(self.selectModelField, self.selectModelBtn)
        Word2VecDialog.setTabOrder(self.selectModelBtn, self.visualizeBtn)
        Word2VecDialog.setTabOrder(self.visualizeBtn, self.searchQueryField)
        Word2VecDialog.setTabOrder(self.searchQueryField, self.searchQueryBtn)
        Word2VecDialog.setTabOrder(self.searchQueryBtn, self.visualizeLogTextEdit)
    ...
    def retranslateUi(self, Word2VecDialog):
        ...
        self.filePathLbl.setText(_translate("Word2VecDialog", "Текстовый файл с входными данными (input file)"))
        self.filePathField.setText(_translate("Word2VecDialog", "input_files/Word2Vec"))
        self.wordFrequencyLbl.setText(_translate("Word2VecDialog", "Минимальное пороговое количество повторений слова (min_count)"))
