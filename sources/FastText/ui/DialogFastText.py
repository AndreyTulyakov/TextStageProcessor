...
class Ui_FastTextDialog(object):
    def setupUi(self, FastTextDialog):
        ...
        self.filePathHLayout.setSizeConstraint(QtWidgets.QLayout.SetMaximumSize)
        self.filePathHLayout.setSpacing(8)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.selectAnotherPathBtn.sizePolicy().hasHeightForWidth())
        self.selectAnotherPathBtn.setSizePolicy(sizePolicy)
        ...
        self.filePathLbl.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.filePathLbl.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.filePathField.setMinimumSize(QtCore.QSize(100, 20))
        self.filePathField.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.configHLayout.addWidget(self.createLogTextEdit)
        self.verticalLayout_4.addLayout(self.configHLayout)
    ...
    def retranslateUi(self, FastTextDialog):
        ...
        self.filePathLbl.setText(_translate("FastTextDialog", "Входные данные (input file)"))
        self.filePathField.setText(_translate("FastTextDialog", "input_files/FastText"))
        self.wordFrequencyLbl.setText(_translate("FastTextDialog", "Количество повторений слова (min_count)"))
